...
/**
 * Video-library wrapper for the shared [CommonFolderListItem].
 * Injects [VideoThumbnail] as the thumbnail slot and passes the
 * video-library's [FolderContextMenu] as [contextMenuContent].
 */
@Composable
fun FolderListItem(
    folder: FolderItem,
