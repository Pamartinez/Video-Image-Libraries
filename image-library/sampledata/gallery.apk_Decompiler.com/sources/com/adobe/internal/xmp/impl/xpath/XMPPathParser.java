...
public final class XMPPathParser {
    ...
    private static XMPPathSegment parseIndexSegment(PathPosition pathPosition) {
        ...
        if ('0' > pathPosition.path.charAt(i2) || pathPosition.path.charAt(pathPosition.stepEnd) > '9') {
            ...
            if (pathPosition.stepEnd >= pathPosition.path.length()) {
                ...
                int i7 = pathPosition.stepEnd;
                pathPosition.nameEnd = i7;
                int i8 = i7 + 1;
                pathPosition.stepEnd = i8;
                char charAt = pathPosition.path.charAt(i8);
                if (charAt == '\'' || charAt == '\"') {
                    pathPosition.stepEnd++;
        ...
        xMPPathSegment.setName(pathPosition.path.substring(pathPosition.stepBegin, i10));
    ...
    private static void parseRootNode(String str, PathPosition pathPosition, XMPPath xMPPath) {
        ...
        int i7 = pathPosition.stepBegin;
        if (i2 != i7) {
            String verifyXPathRoot = verifyXPathRoot(str, pathPosition.path.substring(i7, i2));
    ...
    private static XMPPathSegment parseStructSegment(PathPosition pathPosition) {
        ...
        int i7 = pathPosition.stepBegin;
        if (i2 != i7) {
            return new XMPPathSegment(pathPosition.path.substring(i7, i2), 1);
        }
    ...
    private static void skipPathDelimiter(String str, PathPosition pathPosition) {
        ...
        if (str.charAt(pathPosition.stepBegin) == '*') {
            int i7 = pathPosition.stepBegin + 1;
            pathPosition.stepBegin = i7;
            if (i7 >= str.length() || str.charAt(pathPosition.stepBegin) != '[') {
