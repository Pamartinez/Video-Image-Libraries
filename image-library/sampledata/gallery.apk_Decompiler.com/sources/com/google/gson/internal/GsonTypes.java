...
public final class GsonTypes {
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType, Serializable {
        ...
        public String toString() {
            return GsonTypes.typeToString(this.componentType) + XMPConst.ARRAY_ITEM_NAME;
        }
    }
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public ParameterizedTypeImpl(Type type, Class<?> cls, Type... typeArr) {
            ...
            if (type != null || !GsonTypes.requiresOwnerType(cls)) {
                if (type == null) {
                    ...
                    type2 = GsonTypes.canonicalize(type);
                }
        ...
        public String toString() {
            ...
            for (int i2 = 1; i2 < length; i2++) {
                ...
                sb2.append(GsonTypes.typeToString(this.typeArguments[i2]));
            }
            sb2.append(">");
            return sb2.toString();
        }
    ...
    public static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public WildcardTypeImpl(Type[] typeArr, Type[] typeArr2) {
            ...
            if (typeArr2.length == 1) {
                ...
                GsonPreconditions.checkArgument(typeArr[0] != cls ? false : z7);
        ...
        public int hashCode() {
            ...
            return (this.upperBound.hashCode() + 31) ^ i2;
        }
