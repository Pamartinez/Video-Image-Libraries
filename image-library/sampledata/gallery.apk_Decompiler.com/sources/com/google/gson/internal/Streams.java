    ...
    public static final class AppendableWriter extends Writer {
        ...
        public static class CurrentWrite implements CharSequence {
            ...
            public CharSequence subSequence(int i2, int i7) {
                return new String(this.chars, i2, i7 - i2);
            }
        ...
        public void write(char[] cArr, int i2, int i7) {
            ...
            this.appendable.append(this.currentWrite, i2, i7 + i2);
        }
        ...
        public Writer append(CharSequence charSequence, int i2, int i7) {
            this.appendable.append(charSequence, i2, i7);
            return this;
        }

        public void write(String str, int i2, int i7) {
            Objects.requireNonNull(str);
            this.appendable.append(str, i2, i7 + i2);
        }
