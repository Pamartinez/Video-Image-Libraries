...
@Metadata(d1 = {"\u0000\u0016\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007¢\u0006\u0004\b\u0003\u0010\u0004J\u0010\u0010\u0005\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0007H\u0016J\u0010\u0010\b\u001a\u00020\u00072\u0006\u0010\t\u001a\u00020\u0002H\u0016¨\u0006\n"}, d2 = {"com/google/android/appfunctions/schema/clock/alarms/v1/$CreateAlarmParamsFactory", "Landroidx/appfunctions/internal/AppFunctionSerializableFactory;", "Lcom/google/android/appfunctions/schema/clock/alarms/v1/CreateAlarmParams;", "<init>", "()V", "fromAppFunctionData", "appFunctionData", "Landroidx/appfunctions/AppFunctionData;", "toAppFunctionData", "appFunctionSerializable", "java.com.google.android.libraries.llm.appfunctions.appfunctions_schema2.src.com.google.android.appfunctions.schema.clock.alarms.v1_v1"}, k = 1, mv = {2, 2, 0}, xi = 48)
/* renamed from: com.google.android.appfunctions.schema.clock.alarms.v1.$CreateAlarmParamsFactory  reason: invalid class name */
/* compiled from: r8-map-id-85efad48717c48307252110572a40cba967e8b6d39747b0efe99f107082547d8 */
public final class C$CreateAlarmParamsFactory implements AppFunctionSerializableFactory<CreateAlarmParams> {
    ...
    public final CreateAlarmParams fromAppFunctionData(AppFunctionData appFunctionData) {
        j.e(appFunctionData, "appFunctionData");
        AppFunctionData appFunctionDataWithSpec = super.getAppFunctionDataWithSpec(appFunctionData, "com.google.android.appfunctions.schema.clock.alarms.v1.CreateAlarmParams");
        ? obj = new Object();
        ? obj2 = new Object();
        ...
        if (appFunctionData2 != null) {
            ...
            return new CreateAlarmParams(appFunctionData3 != null ? obj2.fromAppFunctionData(appFunctionData3) : null, fromAppFunctionData, stringOrNull, stringOrNull2, appFunctionDataWithSpec.getStringOrNull("externalId"));
        }
    ...
    public final AppFunctionData toAppFunctionData(CreateAlarmParams createAlarmParams) {
        j.e(createAlarmParams, "appFunctionSerializable");
        ? obj = new Object();
        ? obj2 = new Object();
        AppFunctionData.Builder appFunctionDataBuilder = super.getAppFunctionDataBuilder("com.google.android.appfunctions.schema.clock.alarms.v1.CreateAlarmParams");
        String str = createAlarmParams.f1140a;
        if (str != null) {
            appFunctionDataBuilder.setString("label", str);
        }
        appFunctionDataBuilder.setAppFunctionData("time", obj.toAppFunctionData(createAlarmParams.b));
        String str2 = createAlarmParams.f1141c;
        if (str2 != null) {
            appFunctionDataBuilder.setString("alarmStatus", str2);
        }
        DayPattern dayPattern = createAlarmParams.d;
        if (dayPattern != null) {
            appFunctionDataBuilder.setAppFunctionData("dayPattern", obj2.toAppFunctionData(dayPattern));
        }
        String str3 = createAlarmParams.e;
        if (str3 != null) {
