...
@Metadata(d1 = {"\u0000\u0016\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007¢\u0006\u0004\b\u0003\u0010\u0004J\u0010\u0010\u0005\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0007H\u0016J\u0010\u0010\b\u001a\u00020\u00072\u0006\u0010\t\u001a\u00020\u0002H\u0016¨\u0006\n"}, d2 = {"com/google/android/appfunctions/schema/persons/v1/$PersonFactory", "Landroidx/appfunctions/internal/AppFunctionSerializableFactory;", "Lcom/google/android/appfunctions/schema/persons/v1/Person;", "<init>", "()V", "fromAppFunctionData", "appFunctionData", "Landroidx/appfunctions/AppFunctionData;", "toAppFunctionData", "appFunctionSerializable", "java.com.google.android.libraries.llm.appfunctions.appfunctions_schema2.src.com.google.android.appfunctions.schema.persons.v1_v1"}, k = 1, mv = {2, 2, 0}, xi = 48)
/* renamed from: com.google.android.appfunctions.schema.persons.v1.$PersonFactory  reason: invalid class name */
/* compiled from: r8-map-id-85efad48717c48307252110572a40cba967e8b6d39747b0efe99f107082547d8 */
public final class C$PersonFactory implements AppFunctionSerializableFactory<Person> {
    /* JADX WARNING: type inference failed for: r13v1, types: [com.google.android.appfunctions.schema.persons.v1.$PersonPhoneNumberFactory, java.lang.Object] */
    ...
    public final Person fromAppFunctionData(AppFunctionData appFunctionData) {
        j.e(appFunctionData, "appFunctionData");
        AppFunctionData appFunctionDataWithSpec = super.getAppFunctionDataWithSpec(appFunctionData, "com.google.android.appfunctions.schema.persons.v1.Person");
        ? obj = new Object();
        ? obj2 = new Object();
        C$UriFactory _urifactory = new C$UriFactory();
        String stringOrNull = appFunctionDataWithSpec.getStringOrNull("id");
        if (stringOrNull != null) {
            String stringOrNull2 = appFunctionDataWithSpec.getStringOrNull("displayName");
            if (stringOrNull2 != null) {
                String stringOrNull3 = appFunctionDataWithSpec.getStringOrNull("givenName");
                String stringOrNull4 = appFunctionDataWithSpec.getStringOrNull("middleName");
                String stringOrNull5 = appFunctionDataWithSpec.getStringOrNull("familyName");
                ...
                return new Person(stringOrNull, stringOrNull2, stringOrNull3, stringOrNull4, stringOrNull5, fromAppFunctionData, arrayList, arrayList2);
            }
    ...
    public final AppFunctionData toAppFunctionData(Person person) {
        j.e(person, "appFunctionSerializable");
        ? obj = new Object();
        ? obj2 = new Object();
        C$UriFactory _urifactory = new C$UriFactory();
        AppFunctionData.Builder appFunctionDataBuilder = super.getAppFunctionDataBuilder("com.google.android.appfunctions.schema.persons.v1.Person");
        appFunctionDataBuilder.setString("id", person.f1270a);
        appFunctionDataBuilder.setString("displayName", person.b);
        String str = person.f1271c;
        if (str != null) {
        ...
        ArrayList<PersonPhoneNumber> arrayList = person.g;
        ...
        ArrayList<PersonEmailAddress> arrayList3 = person.f1272h;
