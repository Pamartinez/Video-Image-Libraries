...
public class SuggestAppBarItemWhiteCaseModel<T extends SuggestAppBarItemWhiteCaseView> extends SuggestAppBarItemModel<T> {
    ...
    public /* synthetic */ SuggestAppBarItemWhiteCaseModel(C0748d dVar, Context context, String str, int i2, String str2, int i7, Drawable drawable, AppBarModel.OnClickListener onClickListener, ButtonListModel buttonListModel, int i8, e eVar) {
    ...
    public SuggestAppBarItemWhiteCaseModel(C0748d dVar, Context context, String str, int i2, String str2, int i7, Drawable drawable, AppBarModel.OnClickListener onClickListener, ButtonListModel buttonListModel) {
