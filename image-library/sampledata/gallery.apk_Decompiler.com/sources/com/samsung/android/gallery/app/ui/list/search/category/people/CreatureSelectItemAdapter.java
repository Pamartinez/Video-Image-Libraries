...
public class CreatureSelectItemAdapter<V extends ICreatureSelectView> extends CategoryItemAdapterV2<V> {
    public CreatureSelectItemAdapter(V v, String str, GalleryListView galleryListView, CategoryPropertyHelper categoryPropertyHelper, boolean z) {
    ...
    public int getViewPosition(int i2) {
        return this.mMediaData.findPositionBy((Object) Integer.valueOf(i2));
    }
