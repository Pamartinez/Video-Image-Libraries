...
public class PeopleSelectItemAdapter<V extends ICreatureSelectView> extends CategoryItemAdapterV2<V> {
    public PeopleSelectItemAdapter(V v, String str, GalleryListView galleryListView, CategoryPropertyHelper categoryPropertyHelper, boolean z) {
