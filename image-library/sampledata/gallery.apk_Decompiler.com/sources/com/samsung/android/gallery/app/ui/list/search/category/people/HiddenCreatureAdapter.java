...
public class HiddenCreatureAdapter<V extends ICreatureSelectView> extends CategoryItemHeaderAdapter<V> {
    public HiddenCreatureAdapter(V v, String str, View view, GalleryListView galleryListView, CategoryPropertyHelper categoryPropertyHelper, boolean z) {
