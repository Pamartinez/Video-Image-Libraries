...
public class MoveToSecureFolderMenuItem extends ViewerMenuItem {
    public MoveToSecureFolderMenuItem(EventContext eventContext, ActionInvoker actionInvoker) {
        super(eventContext, actionInvoker, R.string.move_to_secure_folder);
    }
