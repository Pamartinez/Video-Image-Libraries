...
public class BgmListV51 extends BgmListCompat {
    public BgmListV51() {
        HashMap<String, Boolean> hashMap = this.mRelaxing;
        Boolean bool = Boolean.TRUE;
        hashMap.put("Calm", bool);
        this.mRelaxing.put("Gentle Piano", bool);
        this.mRelaxing.put("Sweet Memories", bool);
        this.mRelaxing.put("So Far Away", bool);
        ...
        this.mLounge.put("Good Time", bool);
        this.mLounge.put("Road Trip", bool);
        ...
        this.mHappy.put("Sunrise", bool);
        this.mHappy.put("Waking Up", bool);
        ...
        this.mComic.put("The Voyage (funny mix)", bool2);
        this.mUpbeat.put("Ocean", bool);
        this.mUpbeat.put("Up All Night", bool);
        this.mUpbeat.put("Jazzy Vibes", bool);
        ...
        this.mSentimental.put("The Voyage (sentimental mix)", bool2);
        ...
        this.mMystery.put("The Voyage (mysterious mix)", bool2);
        this.mLovely.put("Sunny Day", bool);
        this.mLovely.put("Sweet Groove", bool);
        this.mLovely.put("Lovely Day", bool);
        this.mLovely.put("Sunset Stroll", bool);
        ...
        this.mLovely.put("The Voyage (romantic mix)", bool2);
        ...
        this.mIntense.put("The Voyage (intense mix)", bool2);
        this.mDynamic.put("Downtown", bool);
        this.mDynamic.put("Festival", bool);
        this.mDynamic.put("Rolling Soul", bool);
        ...
        this.mDynamic.put("The Voyage (dynamic mix)", bool2);
    }
}
