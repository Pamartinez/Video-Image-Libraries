...
public class SearchDocumentItemAdapter extends CategoryGroupItemAdapter {
    ...
    public SearchDocumentItemAdapter(ISearchView iSearchView, String str, GalleryListView galleryListView, CategoryPropertyHelper categoryPropertyHelper, boolean z) {
    ...
    public /* synthetic */ void lambda$getDividerMediaItem$3(MediaItem mediaItem, int i2, String str) {
        ...
        ThreadUtil.postOnUiThread(new C0478a(this, str, mediaItem, i2));
    }

    /* access modifiers changed from: private */
    public static /* synthetic */ int lambda$sortSubCategory$0(Map.Entry entry, Map.Entry entry2) {
        if (SubCategoryType.getOtherDocumentsName().equals(entry.getKey())) {
            return 1;
        }
        if (SubCategoryType.getOtherDocumentsName().equals(entry2.getKey())) {
            return -1;
        }
    ...
    public /* synthetic */ int lambda$updatePositionList$1(Integer num, Integer num2) {
        ...
        int i2 = -Integer.compare(read.getCount(), read2.getCount());
    ...
    public MediaItem getDividerMediaItem(int i2) {
        ...
        SimpleThreadPool.getInstance().execute(new C0478a(this, mediaItem2, i2, str));
        return mediaItem2;
    }
        ...
        if (this.mMediaData != null) {
            ...
            for (int i2 = 0; i2 < this.mMediaData.getCount(); i2++) {
                ...
                if (read != null) {
                    ...
                    hashMap.put(subGroupCategory, updatePositionList((ArrayList) hashMap.get(subGroupCategory), i2));
                    hashMap2.put(subGroupCategory, Integer.valueOf(sum((Integer) hashMap2.get(subGroupCategory), read.getCount())));
