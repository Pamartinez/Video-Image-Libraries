...
public class LocationCategoryDummyAdapter extends RecyclerView.Adapter<ListViewHolder> {
    private final CategoryItemViewHolderFactory mViewHolderFactory;

    public LocationCategoryDummyAdapter(RecyclerView recyclerView) {
        this.mViewHolderFactory = createViewHolderFactory(recyclerView, recyclerView.getContext());
    }

    public CategoryItemViewHolderFactory createViewHolderFactory(RecyclerView recyclerView, Context context) {
