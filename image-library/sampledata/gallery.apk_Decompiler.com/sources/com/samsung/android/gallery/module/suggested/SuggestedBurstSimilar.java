...
public class SuggestedBurstSimilar implements SuggestedInterface {
    public Cursor getCleanOutContentsCoverCursor() {
        return new CleanOutBurstSimilarApi().getCleanOutBurstSimilarCoverCursor();
    }

    public SuggestedUpdateType getType() {
        return SuggestedUpdateType.TYPE_BURST_SIMILAR;
    }
}
