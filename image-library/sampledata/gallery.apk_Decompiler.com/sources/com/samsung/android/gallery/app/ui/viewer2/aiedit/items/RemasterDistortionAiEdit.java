...
public class RemasterDistortionAiEdit extends AbsRemasterAiEdit {
    public RemasterDistortionAiEdit(EventContext eventContext, ActionInvoker actionInvoker) {
        super(eventContext, actionInvoker, AiEditType.FixLensDistortion);
    }

    public void execute(MediaItem mediaItem, boolean z) {
        super.lambda$executeItem$0(mediaItem, z);
        executeOnDemandRemaster(mediaItem, 15, z);
    }
