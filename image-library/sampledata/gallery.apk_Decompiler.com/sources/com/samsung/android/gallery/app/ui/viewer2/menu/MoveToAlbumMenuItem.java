...
public class MoveToAlbumMenuItem extends ViewerMenuItem {
    public MoveToAlbumMenuItem(EventContext eventContext, ActionInvoker actionInvoker) {
        super(eventContext, actionInvoker, R.string.move_to_album);
    }
    ...
    public void setMenuAttribute() {
        setShowAsActionFlag(0).include("location://albums/fileList").validate(ViewerMenuItem.IS_NOT_BROKEN).validate(ViewerMenuItem.IS_NOT_HAVE_QUICK_VIEW_ARGUMENT).validate(ViewerMenuItem.IS_NOT_REMOTE_ITEM).validate(ViewerMenuItem.IS_NOT_UPSM).validate(new b(this, 12));
    }
}
