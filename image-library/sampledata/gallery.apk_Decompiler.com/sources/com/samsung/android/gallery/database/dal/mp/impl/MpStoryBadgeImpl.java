...
public class MpStoryBadgeImpl extends StoryHelperBaseImpl implements StoryBadgeApi {
    public MpStoryBadgeImpl(QueryParams queryParams) {
        super(queryParams);
    }
    ...
    public int getNewStoryCount() {
        ...
        queryBuilder.andCondition("story_type<=100");
        int i2 = 0;
        try {
    ...
    public void updateNotifyStatusViewed(int i2) {
        ...
        update(contentValues, MpStoryColumns.getEditableStoryId() + "=" + i2, (String[]) null);
    }
}
