...
public class DeleteVideoClipMenuItem extends ViewerMenuItem {
    public DeleteVideoClipMenuItem(EventContext eventContext, ActionInvoker actionInvoker) {
        super(eventContext, actionInvoker, R.string.delete_video_clip);
    }
