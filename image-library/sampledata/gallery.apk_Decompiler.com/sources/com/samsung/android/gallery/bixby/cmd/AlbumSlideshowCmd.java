...
public class AlbumSlideshowCmd extends OnThreadCmd {
    ...
    public void executeInternal(Context context) {
        ...
        if (searchAlbumAndGroup) {
            defaultIntent.putExtra("bixby_album_slideshow", true);
        }
    ...
    public boolean support() {
        return "SHOW_ALBUM_SLIDE_SHOW_VIEW".equals(BaseCmd.mAction);
    }
}
