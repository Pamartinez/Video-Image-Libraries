...
public class MpQCloudDbOperation implements DbOperationInterface {
    ...
    public void updateDatabaseByMove(Context context, FileInfo fileInfo) {
        ...
        getDatabaseOperation(context).add(DatabaseOpObject.update(ContentUris.withAppendedId(getCloudUri(), mediaItem.getFileId())).immediate().addValues(getContentValues().getMoveValues(mediaItem, fileInfo.getDestPath(), fileInfo.getFileMode())));
    }
