...
public class BgmListV61 extends BgmListCompat {
    public BgmListV61() {
        HashMap<String, Boolean> hashMap = this.mComic;
        Boolean bool = Boolean.TRUE;
        hashMap.put("Tumble Time", bool);
        this.mComic.put("Ragtime Piano", bool);
        HashMap<String, Boolean> hashMap2 = this.mComic;
        Boolean bool2 = Boolean.FALSE;
        hashMap2.put("Flying", bool2);
