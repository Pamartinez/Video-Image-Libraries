...
public class SearchPickerFragment<V extends ISearchView, P extends SearchPresenter<V>> extends SearchFragment<V, P> {
    View mMainLayout;
    ...
    public /* synthetic */ void lambda$onApplyWindowInsets$0(WindowInsets windowInsets, View view, WindowInsets windowInsets2) {
        PickerViewUtil.adjustViewAreaMargin(windowInsets, ((SearchPresenter) this.mPresenter).getActivityToolBar(), ((SearchPresenter) this.mPresenter).getClipboardView(), view);
    }
    ...
    public WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
        ...
        Optional.ofNullable(view.getRootWindowInsets()).ifPresent(new C0371f((Object) this, (Object) windowInsets, (Object) view, 19));
    ...
    public SearchPresenter<?> createPresenter(ISearchView iSearchView) {
        return new SearchPresenter<ISearchView>(this.mBlackboard, iSearchView) {
