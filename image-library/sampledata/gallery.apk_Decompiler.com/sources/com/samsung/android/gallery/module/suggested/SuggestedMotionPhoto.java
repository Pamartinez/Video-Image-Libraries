...
public class SuggestedMotionPhoto implements SuggestedInterface {
    public Cursor getCleanOutContentsCoverCursor() {
        return new MotionPhotoClipApi().getMotionPhotoClipCoverCursor();
    }

    public SuggestedUpdateType getType() {
        return SuggestedUpdateType.TYPE_MOTION_PHOTO_CLIP;
    }
}
