...
public class ExSumSwitchPreference extends SwitchPreferenceCompat {
    private CharSequence mExtraSummary;
    private int mExtraSummaryColor;
    private int mProgressLayoutId;
    private int mSwitchLayoutId;

    public ExSumSwitchPreference(Context context, AttributeSet attributeSet, int i2, int i7) {
    ...
    private void updateExtraSummary(PreferenceViewHolder preferenceViewHolder) {
        ...
        if (TextUtils.isEmpty(this.mExtraSummary)) {
    ...
    public boolean isProgressShowing() {
        if (getWidgetLayoutResource() == this.mProgressLayoutId) {
            return true;
        }
        return false;
    }
    ...
    public ExSumSwitchPreference(Context context, AttributeSet attributeSet, int i2) {
        super(context, attributeSet, i2);
        init();
    }

    public ExSumSwitchPreference(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        init();
    }

    public ExSumSwitchPreference(Context context) {
        super(context);
        init();
    }
}
