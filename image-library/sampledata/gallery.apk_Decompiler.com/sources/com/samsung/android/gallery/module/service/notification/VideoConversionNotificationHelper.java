...
public class VideoConversionNotificationHelper extends DefaultNotificationHelper {
    public VideoConversionNotificationHelper(Context context, int i2, String str, String str2) {
        super(context, i2, str, str2);
    }

    private PendingIntent getContent(Context context) {
        return AndroidCompat.createServicePendingIntent(context, this.mNotificationId, new Intent("com.samsung.android.gallery.app.service.CALL_ACTIVITY").setClassName("com.sec.android.gallery3d", this.mClassName).putExtra("notification_id", this.mNotificationId).putExtra("notification_data", true), 134217728);
    }
