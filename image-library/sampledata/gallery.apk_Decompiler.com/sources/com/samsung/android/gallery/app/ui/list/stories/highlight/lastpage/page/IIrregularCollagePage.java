...
public interface IIrregularCollagePage extends ISummaryPage {
    IrregularView createIrregularView(ViewGroup viewGroup);

    void initData(IrregularView irregularView);

    void updateCollageSize(IrregularView irregularView, PageSpec.Config config);
}
