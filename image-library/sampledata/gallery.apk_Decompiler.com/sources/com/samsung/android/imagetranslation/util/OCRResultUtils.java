...
public class OCRResultUtils {
    ...
    public static Point[] calculateRotatedRect(ArrayList<OCRResult.LineData> arrayList) {
        ...
        Iterator<OCRResult.LineData> it = arrayList.iterator();
        while (it.hasNext()) {
            arrayList2.addAll(Arrays.asList((PointF[]) Arrays.stream(it.next().getRect()).map(new a(3)).toArray(new Object())));
        }
    ...
    public static void convertOCRResult(com.samsung.android.sdk.ocr.OCRResult r27) {
        /*
            ...
            com.samsung.android.imagetranslation.common.LTTLogger.i(r1, r0)
        ...
        L_0x0022:
            ...
            com.samsung.android.imagetranslation.common.LTTLogger.e(r1, r6)
        ...
        L_0x007b:
            ...
            com.samsung.android.imagetranslation.common.LTTLogger.e(r1, r13)
            int r12 = r12 + 1
            goto L_0x007b
        L_0x0093:
            android.graphics.Point[] r6 = r5.getRect()
        ...
        L_0x00b0:
            ...
            com.samsung.android.imagetranslation.common.LTTLogger.e(r1, r2)
        ...
        L_0x01c8:
            ...
            com.samsung.android.imagetranslation.common.LTTLogger.e(r1, r7)
            java.lang.Object r7 = r14.get(r10)
            com.samsung.android.sdk.ocr.OCRResult$LineData r7 = (com.samsung.android.sdk.ocr.OCRResult.LineData) r7
            android.graphics.Point[] r7 = r7.getRect()
            int r15 = r7.length
        ...
        L_0x0357:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.samsung.android.imagetranslation.util.OCRResultUtils.convertOCRResult(com.samsung.android.sdk.ocr.OCRResult):void");
    }
