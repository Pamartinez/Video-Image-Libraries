...
/* renamed from: com.samsung.android.sivs.ai.sdkcommon.language.z  reason: case insensitive filesystem */
/* compiled from: r8-map-id-85efad48717c48307252110572a40cba967e8b6d39747b0efe99f107082547d8 */
public abstract class C0178z extends Binder implements A {
    static final int TRANSACTION_onComplete = 3;
    static final int TRANSACTION_onError = 2;
    static final int TRANSACTION_onNext = 1;

    /* JADX WARNING: type inference failed for: r0v2, types: [com.samsung.android.sivs.ai.sdkcommon.language.y, java.lang.Object, com.samsung.android.sivs.ai.sdkcommon.language.A] */
    ...
    public boolean onTransact(int i2, Parcel parcel, Parcel parcel2, int i7) {
        ...
        if (i2 != 1598968902) {
            if (i2 == 1) {
                onNext(parcel.createTypedArrayList(Bundle.CREATOR));
