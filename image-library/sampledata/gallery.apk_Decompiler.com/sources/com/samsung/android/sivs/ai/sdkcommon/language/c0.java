    ...
    public final void a(Map map, String str, String str2, LlmServiceObserver2 llmServiceObserver2, Map map2) {
        ...
        try {
            ...
            if (map2 == null) {
                ...
                map2.forEach(new O(obtain, 27));
            }
            this.f1699a.transact(6, obtain, obtain2, 0);
    ...
    public final void b(Map map, String str, String str2, LlmServiceObserver2 llmServiceObserver2, Map map2) {
        ...
        try {
            ...
            if (map2 == null) {
                ...
                obtain.writeInt(map2.size());
                map2.forEach(new O(obtain, 25));
            }
            this.f1699a.transact(4, obtain, obtain2, 0);
            obtain2.readException();
            obtain2.recycle();
            obtain.recycle();
        } catch (Throwable th) {
