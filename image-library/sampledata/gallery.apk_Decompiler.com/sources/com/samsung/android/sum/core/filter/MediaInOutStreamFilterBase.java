...
public abstract class MediaInOutStreamFilterBase extends MediaFilterBase implements MediaInputStreamFilter, MediaOutputStreamFilter {
    ...
    public MediaInOutStreamFilterBase(MFDescriptor mFDescriptor) {
    ...
    public BufferChannel getInputChannel(Enum<?> enumR) {
        return (BufferChannel) Optional.ofNullable(this.inputChannelQuery).map(new b(enumR, 3)).orElse((Object) null);
    }
    ...
    public BufferChannel getOutputChannel(Enum<?> enumR) {
        return (BufferChannel) Optional.ofNullable(this.outputChannelQuery).map(new b(enumR, 2)).orElse((Object) null);
    }
