...
public class VSWGraphicEstimator {
    private static final String TAG = "Remaster-VSWGraphicEstimator";

    public static boolean estimate(byte[] bArr, int i2, int i7) {
        String str = TAG;
        Log.d(str, "estimate - E");
        VSWEngineNativeInterface.printLibraryVersion();
        boolean runGraphicEstimator = VSWEngineNativeInterface.runGraphicEstimator(bArr, i2, i7);
        C0280e.g("result : ", str, str, "estimate - X", runGraphicEstimator);
        return runGraphicEstimator;
    }
