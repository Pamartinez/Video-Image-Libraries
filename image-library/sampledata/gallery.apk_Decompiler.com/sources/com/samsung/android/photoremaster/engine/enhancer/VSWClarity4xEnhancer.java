...
public class VSWClarity4xEnhancer implements IEnhancer {
    private static final String TAG = "Remaster-VSWClarity4xEnhancer";
    ...
    public EnhanceResult enhance(Context context, BgrBuffer bgrBuffer, BgrBuffer bgrBuffer2, double d, List<Rect> list, String str, IRequestCancelledChecker iRequestCancelledChecker) {
        ...
        if (str != null && str.length() > 0) {
            try {
                jSONObject = new JSONObject(str).getJSONObject(VSWClarity4xEnhancer.class.getName()).getJSONObject("estimatedDataJson");
