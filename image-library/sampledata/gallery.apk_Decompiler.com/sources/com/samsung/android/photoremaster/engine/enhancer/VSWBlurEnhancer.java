...
public class VSWBlurEnhancer implements IEnhancer {
    private static final String TAG = "Remaster-VSWBlurEnhancer";

    public static boolean enhance(byte[] bArr, byte[] bArr2, int i2, int i7) {
        String str = TAG;
        Log.d(str, "enhance - E");
        VSWEngineNativeInterface.printLibraryVersion();
        boolean runBlurEnhancer = VSWEngineNativeInterface.runBlurEnhancer(bArr, bArr2, i2, i7);
        C0280e.g("result : ", str, str, "enhance - X", runBlurEnhancer);
        return runBlurEnhancer;
    }
