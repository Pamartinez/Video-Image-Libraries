...
public final class FacebookBarcodeAdapter implements BarcodeParsedResult {
    ...
    public String getTitle() {
        String string = this.appContext.getString(R$string.barcode_title_facebook);
