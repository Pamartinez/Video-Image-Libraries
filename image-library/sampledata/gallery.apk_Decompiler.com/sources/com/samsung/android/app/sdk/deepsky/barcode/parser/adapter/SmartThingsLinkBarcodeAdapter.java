...
public final class SmartThingsLinkBarcodeAdapter implements BarcodeParsedResult {
    ...
    public String getBody() {
        ...
        String string = context.getString(R$string.barcode_body_smarthings_link, new Object[]{getAppName(context)});
        j.d(string, "getString(...)");
        return string;
    }
    ...
    public String getTitle() {
        Context context = this.appContext;
        String string = context.getString(R$string.barcode_title_smarthings_link, new Object[]{getAppName(context)});
        j.d(string, "getString(...)");
        return string;
    }
}
