...
public final class ContactEmailAction extends Action {
    ...
    public /* synthetic */ ContactEmailAction(Context context, C0064d dVar, Injector injector2, int i2, e eVar) {
    ...
    public Intent getIntent() {
        ...
        intent.putExtra("android.intent.extra.EMAIL", this.addressBookParsedResult.f913i);
        return intent;
    }
    ...
    public ContactEmailAction(Context context, C0064d dVar, Injector injector2) {
        super(context);
        j.e(context, "context");
