...
public final class ContactCallAction extends Action {
    ...
    public /* synthetic */ ContactCallAction(Context context, C0064d dVar, Injector injector2, int i2, e eVar) {
    ...
    public Intent getIntent() {
        ...
        intent.setData(Uri.fromParts("tel", this.addressBookParsedResult.g[0], (String) null));
    ...
    public ContactCallAction(Context context, C0064d dVar, Injector injector2) {
        super(context);
        j.e(context, "context");
