...
public final class RtlEndHandle implements HandleDrawStrategy {
    ...
    public Point getEffectiveTouchPoint(Point point, int i2, int i7) {
        ...
        return new Point((i2 / 2) + point.x, point.y - (i7 / 2));
    }

    public RotateDrawable getRotateDrawable(Context context, int i2, boolean z) {
        j.e(context, "context");
        return DrawUtil.INSTANCE.createLeftHandleDrawable(context, i2, z);
    }

    public Point[] getRotatedDefaultRect(int i2, Rect rect) {
        j.e(rect, "defaultRect");
        return PointUtil.INSTANCE.getRotatedRect(rect, i2, new Point(rect.right, rect.top));
    }

    public RotateDrawable getShadowDrawable(Context context) {
        j.e(context, "context");
        return DrawUtil.INSTANCE.createLeftHandleShadowDrawable(context);
    }
    ...
    public Rect getTouchableAreaRect(Rect rect, Rect rect2, int i2) {
        ...
        return pointUtil.getRectContainingPoly(pointUtil.getRotatedRect(rect2, i2, new Point(rect.right, rect.top)));
    }
    ...
    private final Rect getDefaultRect(Point[] pointArr, int i2, int i7) {
        ...
        int i8 = point.x;
        int i10 = point.y;
        return new Rect(i8 - i2, i10, i8, i7 + i10);
    }
}
