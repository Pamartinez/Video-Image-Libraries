...
import com.samsung.android.app.sdk.deepsky.barcode.action.ConnectSmartThingsAction;
...
public final class SmartThingsDeviceBarcodeAdapter implements BarcodeParsedResult {
    ...
    public List<Action> getActions() {
        return C1195m.o0(new ConnectSmartThingsAction(this.appContext, this.parsedResult));
    }

    public String getBody() {
        Context context = this.appContext;
        String string = context.getString(R$string.barcode_title_smarthings_device, new Object[]{getAppName(context)});
        j.d(string, "getString(...)");
        return string;
    }
