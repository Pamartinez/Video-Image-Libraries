...
public final class EngramQueryOptionWrapperV1 implements Parcelable {
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u000e\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007¨\u0006\b"}, d2 = {"Lcom/samsung/android/sdk/moneta/memory/option/wrapper/v1/query/EngramQueryOptionWrapperV1$Companion;", "", "<init>", "()V", "fromOption", "Lcom/samsung/android/sdk/moneta/memory/option/wrapper/v1/query/EngramQueryOptionWrapperV1;", "engramQueryOption", "Lcom/samsung/android/sdk/moneta/memory/option/EngramQueryOption;", "pde-sdk-1.0.40_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
    /* compiled from: r8-map-id-85efad48717c48307252110572a40cba967e8b6d39747b0efe99f107082547d8 */
    public static final class Companion {
        ...
        public final /* synthetic */ EngramQueryOptionWrapperV1 fromOption(EngramQueryOption engramQueryOption) {
            ArrayList arrayList;
            ...
            int value = engramQueryOption2.getQueryType().getValue();
            ...
            return new EngramQueryOptionWrapperV1(startTimestamp, endTimestamp, contentId, value, includeTags, excludeTags, arrayList, arrayList2, engramQueryOption2.getLimit(), engramQueryOption2.getOffset(), engramQueryOption2.getEngramId(), engramQueryOption2.getLatitude(), engramQueryOption2.getLongitude(), engramQueryOption2.getRadius(), engramQueryOption2.getContentFill());
        }
    ...
    /* compiled from: r8-map-id-85efad48717c48307252110572a40cba967e8b6d39747b0efe99f107082547d8 */
    public static final class Creator implements Parcelable.Creator<EngramQueryOptionWrapperV1> {
        public final EngramQueryOptionWrapperV1 createFromParcel(Parcel parcel) {
            ArrayList arrayList;
            ...
            return new EngramQueryOptionWrapperV1(valueOf, valueOf2, readString, readInt, createStringArrayList, createStringArrayList2, arrayList, arrayList2, readInt4, readInt5, readString2, valueOf3, valueOf4, d2, z);
        }

        public final EngramQueryOptionWrapperV1[] newArray(int i2) {
            return new EngramQueryOptionWrapperV1[i2];
        }
    }
    ...
    public final /* synthetic */ EngramQueryOption toOption() {
        ...
        EngramQueryType fromInt = EngramQueryType.Companion.fromInt(this.queryType);
        if (fromInt == null) {
        ...
        if (list3 != null) {
            ...
            for (Number intValue : iterable) {
                ActivityType fromInt2 = ActivityType.Companion.fromInt(intValue.intValue());
                j.b(fromInt2);
                arrayList3.add(fromInt2);
            }
        ...
        if (list4 != null) {
            ...
            for (Number intValue2 : iterable2) {
                ActivityType fromInt3 = ActivityType.Companion.fromInt(intValue2.intValue());
                j.b(fromInt3);
                arrayList2.add(fromInt3);
            }
        }
    ...
    public EngramQueryOptionWrapperV1(Long l, Long l8, String str, int i2, List<String> list, List<String> list2, List<Integer> list3, List<Integer> list4, int i7, int i8, String str2, Double d, Double d2, Double d3, boolean z) {
