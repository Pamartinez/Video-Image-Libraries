...
public class ActionParamExtractionInferenceRunnable extends TaskRunnable<ActionParamExtractionResult> {
    private static final String TAG = "ActionParamExtractionInferenceRunnable";
    ...
    public ActionParamExtractionInferenceRunnable(ExtensionServiceExecutor extensionServiceExecutor) {
    ...
    private void setResult(Bundle bundle) {
        ...
        ActionParamExtractionResult actionParamExtractionResult = new ActionParamExtractionResult();
        int i2 = bundle.getInt(OCRServiceConstant.KEY_RESULT_CODE);
        actionParamExtractionResult.setResult(i2);
        if (i2 != 1) {
            ...
            actionParamExtractionResult.setBundle(bundle);
            this.mSource.setResult(actionParamExtractionResult);
        }
    }

    public void execute() {
        Log.d(TAG, "ActionParamExtractionInferenceRunnable execute()");
    ...
    public String getFeatureName() {
        return Feature.FEATURE_CORE_EXT_ACTION_PARAM_EXTRACTION;
    }
