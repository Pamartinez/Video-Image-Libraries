...
public interface IBuddyInfoResultCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBuddyInfoResultCallback {
        ...
        public static class Proxy implements IBuddyInfoResultCallback {
            public static IBuddyInfoResultCallback sDefaultImpl;
        ...
        public static IBuddyInfoResultCallback getDefaultImpl() {
            return Proxy.sDefaultImpl;
        }

        public static boolean setDefaultImpl(IBuddyInfoResultCallback iBuddyInfoResultCallback) {
            if (Proxy.sDefaultImpl != null || iBuddyInfoResultCallback == null) {
                return false;
            }
            Proxy.sDefaultImpl = iBuddyInfoResultCallback;
            return true;
        }
    ...
    /* compiled from: r8-map-id-85efad48717c48307252110572a40cba967e8b6d39747b0efe99f107082547d8 */
    public static class Default implements IBuddyInfoResultCallback {
        public IBinder asBinder() {
            return null;
        }
