...
class GetResourcePackPackageNameRunnable extends TaskRunnable<String> {
    ...
    public GetResourcePackPackageNameRunnable(NeuralTranslationServiceExecutor neuralTranslationServiceExecutor2, String str, String str2) {
    ...
    public void execute() {
        try {
            this.mSource.setResult(((f) this.neuralTranslationServiceExecutor.getTranslationService()).c(this.sourceLanguageCode, this.targetLanguageCode));
