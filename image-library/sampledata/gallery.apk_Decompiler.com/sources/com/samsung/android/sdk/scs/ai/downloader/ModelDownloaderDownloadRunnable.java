...
public class ModelDownloaderDownloadRunnable extends TaskRunnable<Integer> {
    ...
    public void execute() {
        Log.i(TAG, "execute");
        try {
            this.mSource.getTask().getTaskId();
            this.mSource.setResult(Integer.valueOf(((C0727a) this.mServiceExecutor.getDownloadService()).d(this.mFeature)));
