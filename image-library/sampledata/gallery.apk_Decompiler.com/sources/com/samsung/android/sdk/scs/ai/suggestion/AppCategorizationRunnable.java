...
public class AppCategorizationRunnable extends TaskRunnable<List<String>> {
    private static final String TAG = "AppCategorizationRunnable";
    private Context mContext;
    private ArrayList<String> mPackageNames = new ArrayList<>();

    public AppCategorizationRunnable(Context context) {
    ...
    public void execute() {
        ...
        Bundle call = contentResolver.call(Uri.parse("content://com.samsung.android.scs.ai.suggestion"), "methodSuggestAppCategory", (String) null, bundle);
        if (call == null) {
        ...
        if (i2 != 1) {
            ...
            ArrayList<String> stringArrayList = call.getStringArrayList("resultSuggestAppCategories");
    ...
    public String getFeatureName() {
        return Feature.FEATURE_SUGGESTION_SUGGEST_APP_CATEGORY;
    }
