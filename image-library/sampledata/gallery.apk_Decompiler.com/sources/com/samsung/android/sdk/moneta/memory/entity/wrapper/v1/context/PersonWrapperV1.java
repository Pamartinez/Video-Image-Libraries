...
public final class PersonWrapperV1 implements Parcelable {
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u000e\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007¨\u0006\b"}, d2 = {"Lcom/samsung/android/sdk/moneta/memory/entity/wrapper/v1/context/PersonWrapperV1$Companion;", "", "<init>", "()V", "fromContext", "Lcom/samsung/android/sdk/moneta/memory/entity/wrapper/v1/context/PersonWrapperV1;", "person", "Lcom/samsung/android/sdk/moneta/memory/entity/context/Person;", "pde-sdk-1.0.40_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
    /* compiled from: r8-map-id-85efad48717c48307252110572a40cba967e8b6d39747b0efe99f107082547d8 */
    public static final class Companion {
        ...
        public final /* synthetic */ PersonWrapperV1 fromContext(Person person) {
            j.e(person, "person");
            return new PersonWrapperV1(person.getId(), person.getName(), person.getRelationships(), person.getContactId(), person.getPersonId());
        }
    ...
    /* compiled from: r8-map-id-85efad48717c48307252110572a40cba967e8b6d39747b0efe99f107082547d8 */
    public static final class Creator implements Parcelable.Creator<PersonWrapperV1> {
        public final PersonWrapperV1 createFromParcel(Parcel parcel) {
            j.e(parcel, "parcel");
            ...
            return new PersonWrapperV1(readString, readString2, createStringArrayList, valueOf, l);
        }

        public final PersonWrapperV1[] newArray(int i2) {
            return new PersonWrapperV1[i2];
        }
    }

    public PersonWrapperV1(String str, String str2, List<String> list, Long l, Long l8) {
        j.e(str, "id");
        j.e(str2, "name");
