...
public final class ListeningToMusicActivity extends Activity {
    ...
    /* compiled from: r8-map-id-85efad48717c48307252110572a40cba967e8b6d39747b0efe99f107082547d8 */
    public static final class Creator implements Parcelable.Creator<ListeningToMusicActivity> {
        public final ListeningToMusicActivity createFromParcel(Parcel parcel) {
            j.e(parcel, "parcel");
            ...
            int i7 = 0;
            while (i7 != readInt) {
                i7 = a.b(ListeningToMusicActivity.class, parcel, arrayList, i7, 1);
            }
            ...
            return new ListeningToMusicActivity(readString, arrayList, createFromParcel, readLong, valueOf, arrayList2);
        }

        public final ListeningToMusicActivity[] newArray(int i2) {
            return new ListeningToMusicActivity[i2];
        }
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ ListeningToMusicActivity(String str, List list, MediaSession mediaSession, long j2, Long l, List list2, int i2, e eVar) {
        this(str, list, mediaSession, j2, l, (i2 & 32) != 0 ? C1202t.d : list2);
    }

    public static /* synthetic */ ListeningToMusicActivity copy$default(ListeningToMusicActivity listeningToMusicActivity, String str, List<Content> list, MediaSession mediaSession, long j2, Long l, List<MobileApplication> list2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        if ((i2 & 8) != 0) {
            j2 = listeningToMusicActivity.startTimestamp;
        }
        if ((i2 & 16) != 0) {
            l = listeningToMusicActivity.endTimestamp;
        }
        if ((i2 & 32) != 0) {
            list2 = listeningToMusicActivity.executionApp;
        }
        long j3 = j2;
        List<Content> list3 = list;
        MediaSession mediaSession2 = mediaSession;
        return listeningToMusicActivity.copy(str, list3, mediaSession2, j3, l, list2);
    }
    ...
    public final ListeningToMusicActivity copy(String str, List<? extends Content> list, MediaSession mediaSession, long j2, Long l, List<MobileApplication> list2) {
        j.e(str, "id");
        j.e(list, "contents");
        j.e(mediaSession, "iconic");
        j.e(list2, "executionApp");
        return new ListeningToMusicActivity(str, list, mediaSession, j2, l, list2);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (j.a(this.id, listeningToMusicActivity.id) && j.a(this.contents, listeningToMusicActivity.contents) && j.a(this.iconic, listeningToMusicActivity.iconic) && this.startTimestamp == listeningToMusicActivity.startTimestamp && j.a(this.endTimestamp, listeningToMusicActivity.endTimestamp) && j.a(this.executionApp, listeningToMusicActivity.executionApp)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        StringBuilder sb2 = new StringBuilder("ListeningToMusicActivity(id=");
        sb2.append(this.id);
        sb2.append(", contents=");
    ...
    public ListeningToMusicActivity(String str, List<? extends Content> list, MediaSession mediaSession, long j2, Long l, List<MobileApplication> list2) {
