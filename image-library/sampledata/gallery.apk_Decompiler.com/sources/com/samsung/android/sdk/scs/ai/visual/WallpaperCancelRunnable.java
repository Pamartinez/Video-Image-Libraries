...
public class WallpaperCancelRunnable extends TaskRunnable<Boolean> {
    private static final String TAG = "WallpaperCancelRunnable";
    WallpaperServiceExecutor mServiceExecutor;
    private String mTaskId;

    public WallpaperCancelRunnable(WallpaperServiceExecutor wallpaperServiceExecutor) {
    ...
    public void execute() {
        ...
        try {
            ...
            setResult(((s) this.mServiceExecutor.getWallpaperService()).a(bundle));
