...
public class WallpaperReleaseRunnable extends TaskRunnable<Boolean> {
    private static final String TAG = "WallpaperReleaseRunnable";
    WallpaperServiceExecutor mServiceExecutor;

    public WallpaperReleaseRunnable(WallpaperServiceExecutor wallpaperServiceExecutor) {
    ...
    public void execute() {
        ...
        try {
            ...
            sVar.f4192a.transact(4, obtain, obtain2, 0);
