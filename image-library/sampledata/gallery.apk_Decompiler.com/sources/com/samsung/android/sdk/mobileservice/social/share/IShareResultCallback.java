...
public interface IShareResultCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IShareResultCallback {
        ...
        public static class Proxy implements IShareResultCallback {
            public static IShareResultCallback sDefaultImpl;
        ...
        public static IShareResultCallback getDefaultImpl() {
            return Proxy.sDefaultImpl;
        }

        public static boolean setDefaultImpl(IShareResultCallback iShareResultCallback) {
            if (Proxy.sDefaultImpl != null || iShareResultCallback == null) {
                return false;
            }
            Proxy.sDefaultImpl = iShareResultCallback;
            return true;
        }
        ...
        public boolean onTransact(int r5, android.os.Parcel r6, android.os.Parcel r7, int r8) {
            /*
                ...
                r1 = 1
                java.lang.String r2 = "com.samsung.android.sdk.mobileservice.social.share.IShareResultCallback"
            ...
            L_0x005d:
                r6.enforceInterface(r2)
                android.os.Parcelable$Creator r5 = android.os.Bundle.CREATOR
                java.util.ArrayList r8 = r6.createTypedArrayList(r5)
            ...
            L_0x0071:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.samsung.android.sdk.mobileservice.social.share.IShareResultCallback.Stub.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean");
        }
    ...
    /* compiled from: r8-map-id-85efad48717c48307252110572a40cba967e8b6d39747b0efe99f107082547d8 */
    public static class Default implements IShareResultCallback {
        public IBinder asBinder() {
            return null;
        }
