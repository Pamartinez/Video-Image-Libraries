...
public class CommonStatusCodes {
    ...
    public static final int NOT_FOUND_IN_CONTACT = 131;
    public static final int NOT_REGISTERED_APP_ID = 130;
    ...
    public static final int NOT_SUPPORTED_RECEIVER = 132;
    ...
    public static final int SA_FAMILY_GROUP_IS_NOT_EXIST = 127;
    public static final int SA_FAMILY_GROUP_PERMISSION_ERROR = 128;
    ...
    public static final int SHARE_ITEM_IS_UPLOADING = 134;
    ...
    public static final int UNREACHABLE_RECEIVER = 133;
    public static final int UNSUPPORTED_USER_REQUEST_APP_UPDATE_AND_LAUNCH = 129;
