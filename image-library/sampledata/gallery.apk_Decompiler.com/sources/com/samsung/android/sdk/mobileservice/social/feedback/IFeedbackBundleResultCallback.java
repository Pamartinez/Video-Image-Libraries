...
public interface IFeedbackBundleResultCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IFeedbackBundleResultCallback {
        ...
        public static class Proxy implements IFeedbackBundleResultCallback {
            public static IFeedbackBundleResultCallback sDefaultImpl;
        ...
        public static IFeedbackBundleResultCallback getDefaultImpl() {
            return Proxy.sDefaultImpl;
        }

        public static boolean setDefaultImpl(IFeedbackBundleResultCallback iFeedbackBundleResultCallback) {
            if (Proxy.sDefaultImpl != null || iFeedbackBundleResultCallback == null) {
                return false;
            }
            Proxy.sDefaultImpl = iFeedbackBundleResultCallback;
            return true;
        }
    ...
    /* compiled from: r8-map-id-85efad48717c48307252110572a40cba967e8b6d39747b0efe99f107082547d8 */
    public static class Default implements IFeedbackBundleResultCallback {
        public IBinder asBinder() {
            return null;
        }
