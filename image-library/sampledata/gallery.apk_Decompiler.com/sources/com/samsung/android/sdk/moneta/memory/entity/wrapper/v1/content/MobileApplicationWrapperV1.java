...
public final class MobileApplicationWrapperV1 extends ContentWrapper {
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u000e\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007¨\u0006\b"}, d2 = {"Lcom/samsung/android/sdk/moneta/memory/entity/wrapper/v1/content/MobileApplicationWrapperV1$Companion;", "", "<init>", "()V", "fromContent", "Lcom/samsung/android/sdk/moneta/memory/entity/wrapper/v1/content/MobileApplicationWrapperV1;", "mobileApplication", "Lcom/samsung/android/sdk/moneta/memory/entity/content/MobileApplication;", "pde-sdk-1.0.40_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
    /* compiled from: r8-map-id-85efad48717c48307252110572a40cba967e8b6d39747b0efe99f107082547d8 */
    public static final class Companion {
        ...
        public final /* synthetic */ MobileApplicationWrapperV1 fromContent(MobileApplication mobileApplication) {
            j.e(mobileApplication, SearchingActivityBundleWrapper.BUNDLE_KEY_MOBILE_APPLICATION);
            return new MobileApplicationWrapperV1(mobileApplication.getId(), mobileApplication.getPackageId(), mobileApplication.getName(), mobileApplication.getAltNames());
        }
    ...
    /* compiled from: r8-map-id-85efad48717c48307252110572a40cba967e8b6d39747b0efe99f107082547d8 */
    public static final class Creator implements Parcelable.Creator<MobileApplicationWrapperV1> {
        public final MobileApplicationWrapperV1 createFromParcel(Parcel parcel) {
            j.e(parcel, "parcel");
            return new MobileApplicationWrapperV1(parcel.readString(), parcel.readString(), parcel.readString(), parcel.createStringArrayList());
        }

        public final MobileApplicationWrapperV1[] newArray(int i2) {
            return new MobileApplicationWrapperV1[i2];
        }
    }
