...
public interface IGroupListResultCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGroupListResultCallback {
        ...
        public static class Proxy implements IGroupListResultCallback {
            public static IGroupListResultCallback sDefaultImpl;
        ...
        public static IGroupListResultCallback getDefaultImpl() {
            return Proxy.sDefaultImpl;
        }

        public static boolean setDefaultImpl(IGroupListResultCallback iGroupListResultCallback) {
            if (Proxy.sDefaultImpl != null || iGroupListResultCallback == null) {
                return false;
            }
            Proxy.sDefaultImpl = iGroupListResultCallback;
            return true;
        }
    ...
    /* compiled from: r8-map-id-85efad48717c48307252110572a40cba967e8b6d39747b0efe99f107082547d8 */
    public static class Default implements IGroupListResultCallback {
        public IBinder asBinder() {
            return null;
        }
