...
public class ErrorCodeConvertor {
    ...
    public static final long BUDDY_BAD_REQUEST = 137421;
    public static final long BUDDY_NOT_FOUND_IN_CONTACT = 137452;
    public static final long BUDDY_NOT_REGISTERED_APP_ID = 137451;
    public static final long BUDDY_NOT_REGISTERED_USER = 137410;
    public static final long BUDDY_NOT_SUPPORTED_RECEIVER = 137453;
    public static final long BUDDY_UNREACHABLE_RECEIVER = 137456;
    public static final long BUDDY_UNSUPPORTED_USER_REQUEST_EXECUTION = 137455;
    public static final String CALLER_NOT_ACTIVITY = "SAC_0106";
    public static final long CHINA_SERVICE_DOWNTIME = 102203;
    public static final long CHINA_SERVICE_WITHDRAWAL = 102204;
    ...
    public static final long GRAPH_NOT_FOUND_IN_CONTACT = 123452;
    public static final long GRAPH_NOT_REGISTERED_APP_ID = 123451;
    public static final long GRAPH_NOT_SUPPORTED_RECEIVER = 123453;
    public static final long GRAPH_UNREACHABLE_RECEIVER = 123456;
    public static final long GRAPH_UNSUPPORTED_USER_REQUEST_EXECUTION = 123455;
    ...
    public static final long GROUP_SA_FAMILY_GROUP_IS_NOT_EXIST = 4000701091L;
    public static final long GROUP_SA_FAMILY_GROUP_PERMISSION_ERROR = 4000701092L;
    ...
    public static final long SHARE_SPACE_ALREADY_EXISTS = 112505;
    ...
    public static final int TEMP_BUDDY_BAD_REQUEST = 137421;
    public static final int TEMP_BUDDY_NOT_FOUND_IN_CONTACT = 137452;
    public static final int TEMP_BUDDY_NOT_REGISTERED_APP_ID = 137451;
    public static final int TEMP_BUDDY_NOT_REGISTERED_USER = 137410;
    public static final int TEMP_BUDDY_NOT_SUPPORTED_RECEIVER = 137453;
    public static final int TEMP_BUDDY_UNREACHABLE_RECEIVER = 137456;
    public static final int TEMP_BUDDY_UNSUPPORTED_USER_REQUEST_EXECUTION = 137455;
    public static final int TEMP_CHINA_SERVICE_DOWNTIME = 102203;
    public static final int TEMP_CHINA_SERVICE_WITHDRAWAL = 102204;
    public static final int TEMP_ERROR_ITEM_IS_UPLOADING = 1052;
    ...
    public static final int TEMP_GRAPH_NOT_FOUND_IN_CONTACT = 123452;
    public static final int TEMP_GRAPH_NOT_REGISTERED_APP_ID = 123451;
    public static final int TEMP_GRAPH_NOT_SUPPORTED_RECEIVER = 123453;
    public static final int TEMP_GRAPH_UNREACHABLE_RECEIVER = 123456;
    public static final int TEMP_GRAPH_UNSUPPORTED_USER_REQUEST_EXECUTION = 123455;
    ...
    private static HashMap<Integer, Integer> errorMapInteger;
    private static HashMap<Long, Integer> errorMapLong;

    static {
        HashMap<String, Integer> hashMap = new HashMap<>();
        errorMap = hashMap;
        hashMap.put(INVALID_PARAMETER, 101);
        ...
        errorMap.put(POLICY_NOT_SUPPORTED_COUNTRY, 201);
        errorMap.put(POLICY_NOT_SUPPORTED_CARRIER, 202);
        ...
        errorMapInteger.put(Integer.valueOf(TEMP_AGENT_INVALID_PARAMETER), 101);
        errorMapInteger.put(Integer.valueOf(TEMP_AGENT_INTERNAL_ERROR), 301);
        errorMapInteger.put(1008, 301);
        errorMapInteger.put(Integer.valueOf(TEMP_AGENT_FILE_IO_ERROR), 301);
        errorMapInteger.put(Integer.valueOf(TEMP_AGENT_SERVICE_DISABLED), 6);
        errorMapInteger.put(Integer.valueOf(TEMP_AGENT_INVALID_MSISDN), 105);
        errorMapInteger.put(Integer.valueOf(TEMP_AGENT_NOT_ACTIVATED), 7);
        errorMapInteger.put(Integer.valueOf(TEMP_AGENT_NOT_USER_OWNER), 105);
        errorMapInteger.put(Integer.valueOf(TEMP_AGENT_VOLLEY_CANCELED), 106);
        errorMapInteger.put(Integer.valueOf(TEMP_AGENT_VOLLEY_NETWORK_TIMEOUT), 103);
        errorMapInteger.put(Integer.valueOf(TEMP_AGENT_VOLLEY_INTERNAL_NETWORK), 103);
        errorMapInteger.put(Integer.valueOf(TEMP_AGENT_VOLLEY_PARSING), 101);
        errorMapInteger.put(Integer.valueOf(TEMP_RESOURCE_NOT_FOUND), 107);
        errorMapInteger.put(400, 103);
        errorMapInteger.put(Integer.valueOf(TEMP_AGENT_WIFI_ONLY_MODEL), 18);
        errorMapInteger.put(Integer.valueOf(ERROR_NOT_SUPPORTED_API), 203);
        ...
        errorMapInteger.put(Integer.valueOf(TEMP_CHINA_SERVICE_DOWNTIME), 121);
        errorMapInteger.put(Integer.valueOf(TEMP_CHINA_SERVICE_WITHDRAWAL), 121);
        ...
        errorMapInteger.put(Integer.valueOf(TEMP_BUDDY_NOT_REGISTERED_USER), 15);
        errorMapInteger.put(Integer.valueOf(TEMP_BUDDY_BAD_REQUEST), 101);
        errorMapInteger.put(Integer.valueOf(TEMP_BUDDY_NOT_REGISTERED_APP_ID), 130);
        errorMapInteger.put(Integer.valueOf(TEMP_BUDDY_NOT_FOUND_IN_CONTACT), 131);
        errorMapInteger.put(Integer.valueOf(TEMP_BUDDY_NOT_SUPPORTED_RECEIVER), 132);
        errorMapInteger.put(Integer.valueOf(TEMP_BUDDY_UNSUPPORTED_USER_REQUEST_EXECUTION), 129);
        errorMapInteger.put(Integer.valueOf(TEMP_BUDDY_UNREACHABLE_RECEIVER), 133);
        errorMapInteger.put(Integer.valueOf(TEMP_GRAPH_NOT_REGISTERED_APP_ID), 130);
        errorMapInteger.put(Integer.valueOf(TEMP_GRAPH_NOT_FOUND_IN_CONTACT), 131);
        errorMapInteger.put(Integer.valueOf(TEMP_GRAPH_NOT_SUPPORTED_RECEIVER), 132);
        errorMapInteger.put(Integer.valueOf(TEMP_GRAPH_UNSUPPORTED_USER_REQUEST_EXECUTION), 129);
        errorMapInteger.put(Integer.valueOf(TEMP_GRAPH_UNREACHABLE_RECEIVER), 133);
        errorMapInteger.put(Integer.valueOf(TEMP_ERROR_ITEM_IS_UPLOADING), 134);
        ...
        errorMapLong.put(Long.valueOf(ERROR_NOT_ALLOWED_CALLER), -6);
        ...
        errorMapLong.put(Long.valueOf(ERROR_MISMATCH_OWNER), 125);
        ...
        errorMapLong.put(Long.valueOf(SHARE_SPACE_ALREADY_EXISTS), 126);
        errorMapLong.put(1052L, 134);
        ...
        errorMapLong.put(Long.valueOf(CHINA_SERVICE_DOWNTIME), 121);
        errorMapLong.put(Long.valueOf(CHINA_SERVICE_WITHDRAWAL), 121);
        errorMapLong.put(Long.valueOf(GROUP_PARAMETER_REQUIRED), 101);
        errorMapLong.put(Long.valueOf(GROUP_PARAMETER_BAD_FORMAT), 101);
        errorMapLong.put(Long.valueOf(GROUP_INVALID_GROUP_ID), 124);
        errorMapLong.put(Long.valueOf(GROUP_INVALID_GROUP_TYPE), 101);
        errorMapLong.put(Long.valueOf(GROUP_INVALID_MEMBER_ID), 123);
        ...
        errorMapLong.put(Long.valueOf(GROUP_SA_FAMILY_GROUP_IS_NOT_EXIST), 127);
        errorMapLong.put(Long.valueOf(GROUP_SA_FAMILY_GROUP_PERMISSION_ERROR), 128);
        errorMapLong.put(Long.valueOf(BUDDY_NOT_REGISTERED_USER), 15);
        errorMapLong.put(Long.valueOf(BUDDY_BAD_REQUEST), 101);
        errorMapLong.put(Long.valueOf(BUDDY_NOT_REGISTERED_APP_ID), 130);
        errorMapLong.put(Long.valueOf(BUDDY_NOT_FOUND_IN_CONTACT), 131);
        errorMapLong.put(Long.valueOf(BUDDY_NOT_SUPPORTED_RECEIVER), 132);
        errorMapLong.put(Long.valueOf(BUDDY_UNSUPPORTED_USER_REQUEST_EXECUTION), 129);
        errorMapLong.put(Long.valueOf(BUDDY_UNREACHABLE_RECEIVER), 133);
        errorMapLong.put(Long.valueOf(GRAPH_NOT_REGISTERED_APP_ID), 130);
        errorMapLong.put(Long.valueOf(GRAPH_NOT_FOUND_IN_CONTACT), 131);
        errorMapLong.put(Long.valueOf(GRAPH_NOT_SUPPORTED_RECEIVER), 132);
        errorMapLong.put(Long.valueOf(GRAPH_UNSUPPORTED_USER_REQUEST_EXECUTION), 129);
        errorMapLong.put(Long.valueOf(GRAPH_UNREACHABLE_RECEIVER), 133);
    }
    ...
    public static int convertErrorcode(int i2) {
        int i7;
        if (errorMapInteger.containsKey(Integer.valueOf(i2))) {
            i7 = errorMapInteger.get(Integer.valueOf(i2)).intValue();
        } else {
            String num = Integer.toString(i2);
            if (num.length() == 8 || num.length() == 10) {
                try {
                    int parseInt = Integer.parseInt(Integer.toString(i2).substring(0, 3));
                    if (parseInt >= 400 && parseInt < 500) {
                        i7 = 100;
                    } else if (parseInt >= 500) {
                        i7 = -4;
        ...
        SdkLog.d(TAG, a.d(i2, i7, "convertErrorcode : code = [", "], ret = [", "]"));
        return i7;
    }

    public static int convertErrorcode(long j2) {
        int i2;
        if (errorMapLong.containsKey(Long.valueOf(j2))) {
            i2 = errorMapLong.get(Long.valueOf(j2)).intValue();
        } else {
        ...
        SdkLog.d(TAG, "convertErrorcode : code = [" + j2 + "], ret = [" + i2 + "]");
        return i2;
    }
}
