...
public class SceneText implements Cloneable {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                com.samsung.android.livetranslation.text.SceneText$SceneTextType[] r0 = com.samsung.android.livetranslation.text.SceneText.SceneTextType.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$com$samsung$android$livetranslation$text$SceneText$SceneTextType = r0
                com.samsung.android.livetranslation.text.SceneText$SceneTextType r1 = com.samsung.android.livetranslation.text.SceneText.SceneTextType.PARAGRAPH     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$com$samsung$android$livetranslation$text$SceneText$SceneTextType     // Catch:{ NoSuchFieldError -> 0x001d }
                com.samsung.android.livetranslation.text.SceneText$SceneTextType r1 = com.samsung.android.livetranslation.text.SceneText.SceneTextType.LINE     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = $SwitchMap$com$samsung$android$livetranslation$text$SceneText$SceneTextType     // Catch:{ NoSuchFieldError -> 0x0028 }
                com.samsung.android.livetranslation.text.SceneText$SceneTextType r1 = com.samsung.android.livetranslation.text.SceneText.SceneTextType.WORD     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.samsung.android.livetranslation.text.SceneText.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public Size calculateBlockDimensions() {
        ...
        this.mBlockWidth = (int) Math.sqrt(Math.pow((double) (pointArr[1].y - pointArr[0].y), 2.0d) + Math.pow((double) (pointArr[1].x - pointArr[0].x), 2.0d));
        this.mBlockHeight = (int) Math.sqrt(Math.pow((double) (pointArr[3].y - pointArr[0].y), 2.0d) + Math.pow((double) (pointArr[3].x - pointArr[0].x), 2.0d));
