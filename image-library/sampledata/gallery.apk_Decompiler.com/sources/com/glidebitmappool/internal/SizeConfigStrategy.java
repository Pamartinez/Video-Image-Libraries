...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    public static final class Key implements Poolable {
        ...
        public void init(int i2, Bitmap.Config config2) {
            this.size = i2;
            this.config = config2;
        }
    ...
    private Key findBestKey(int i2, Bitmap.Config config) {
        ...
        while (true) {
            ...
            Bitmap.Config config2 = inConfigs[i7];
            Integer ceilingKey = getSizesForConfig(config2).ceilingKey(Integer.valueOf(i2));
            if (ceilingKey == null || ceilingKey.intValue() > i2 * 8) {
                i7++;
            } else if (ceilingKey.intValue() != i2 || !Objects.equals(config2, config)) {
    ...
    public Bitmap get(int i2, int i7, Bitmap.Config config) {
        Key findBestKey = findBestKey(Util.getBitmapByteSize(i2, i7, config), config);
    ...
    public void put(Bitmap bitmap) {
        ...
        this.mTotalCount++;
        Key key = this.keyPool.get(bitmapByteSize, bitmap.getConfig());
        ...
        sizesForConfig.put(valueOf, Integer.valueOf(i2));
    }
    ...
    public String toString() {
        StringBuilder s = C0212a.s("SizeConfigStrategy{groupedMap=");
        s.append(this.groupedMap);
    ...
    public String logBitmap(int i2, int i7, Bitmap.Config config) {
        return getBitmapString(Util.getBitmapByteSize(i2, i7, config), config);
    }
}
