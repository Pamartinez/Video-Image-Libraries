...
public final class s extends i implements c {
    ...
    public s(String str, C1227c cVar) {
        super(2, cVar);
        this.e = str;
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        return ((s) create(new k(((k) obj).d), (C1227c) obj2)).invokeSuspend(x.f4917a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (a7 == null) {
            ...
            Log.i(access$getTAG$cp, "get available languages from " + str + " X");
