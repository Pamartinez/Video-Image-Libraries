...
public final class C0911i extends C0904b {
    public static final /* synthetic */ t[] g;
    public final i f;

    static {
        w wVar = v.f4727a;
        g = new t[]{wVar.f(new p(wVar.b(C0911i.class), "allValueArguments", "getAllValueArguments()Ljava/util/Map;"))};
    }

    /* JADX WARNING: type inference failed for: r0v4, types: [Gf.h, Gf.i] */
    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C0911i(C0893e eVar, a aVar) {
        super(aVar, eVar, Ne.p.w);
        j.e(eVar, "annotation");
        j.e(aVar, "c");
