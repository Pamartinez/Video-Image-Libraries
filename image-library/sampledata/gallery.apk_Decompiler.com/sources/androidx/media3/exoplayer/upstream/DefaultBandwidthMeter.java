...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    public static final U DEFAULT_INITIAL_BITRATE_ESTIMATES_2G = U.E(1500000L, 980000L, 750000L, 520000L, 290000L);
    public static final U DEFAULT_INITIAL_BITRATE_ESTIMATES_3G = U.E(2000000L, 1300000L, 1000000L, 860000L, 610000L);
    public static final U DEFAULT_INITIAL_BITRATE_ESTIMATES_4G = U.E(2500000L, 1700000L, 1200000L, 970000L, 680000L);
    public static final U DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_NSA = U.E(4700000L, 2800000L, 2100000L, 1700000L, 980000L);
    public static final U DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_SA = U.E(2700000L, 2000000L, 1600000L, 1300000L, 1000000L);
    public static final U DEFAULT_INITIAL_BITRATE_ESTIMATES_WIFI = U.E(4300000L, 3200000L, 2400000L, 1700000L, 860000L);
    ...
    private final Y initialBitrateEstimates;
    ...
    private static int[] getInitialBitrateCountryGroupAssignment(java.lang.String r3) {
        /*
            r3.getClass()
            int r0 = r3.hashCode()
            r1 = 6
    ...
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private long getInitialBitrateEstimateForNetworkType(int r6) {
        /*
            r5 = this;
            F2.Y r0 = r5.initialBitrateEstimates
            java.lang.Integer r1 = java.lang.Integer.valueOf(r6)
            java.lang.Object r0 = r0.get(r1)
            java.lang.Long r0 = (java.lang.Long) r0
            if (r0 != 0) goto L_0x001d
            F2.Y r5 = r5.initialBitrateEstimates
            r6 = 0
        ...
        L_0x001d:
            ...
            long r5 = getInitialBitrateEstimatesForCountry(r5, r6)
        ...
        L_0x003d:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media3.exoplayer.upstream.DefaultBandwidthMeter.getInitialBitrateEstimateForNetworkType(int):long");
    }

    private static long getInitialBitrateEstimatesForCountry(String str, int i2) {
        if (str == null) {
            str = "";
        }
    ...
    public synchronized void onNetworkTypeChanged(int i2) {
        ...
        try {
            ...
            if (i8 != i2 || this.countryCode == null) {
                this.networkType = i2;
                if (i2 != 1 && i2 != 0 && i2 != 8) {
                    ...
                    if (this.streamCount > 0) {
                        i7 = (int) (elapsedRealtime - this.sampleStartTimeMs);
                    } else {
                        i7 = 0;
                    }
                    defaultBandwidthMeter = this;
                    try {
                        defaultBandwidthMeter.maybeNotifyBandwidthSample(i7, this.sampleBytesTransferred, this.bitrateEstimate);
                        defaultBandwidthMeter.sampleStartTimeMs = elapsedRealtime;
                        defaultBandwidthMeter.sampleBytesTransferred = 0;
                        defaultBandwidthMeter.totalBytesTransferred = 0;
                        defaultBandwidthMeter.totalElapsedTimeMs = 0;
                        defaultBandwidthMeter.slidingPercentile.reset();
                    } catch (Throwable th3) {
                        th = th3;
                        th = th;
                        throw th;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x004e, code lost:
        if (r10.totalBytesTransferred >= 524288) goto L_0x0055;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized void onTransferEnd(androidx.media3.datasource.DataSource r11, androidx.media3.datasource.DataSpec r12, boolean r13) {
        /*
            r10 = this;
            monitor-enter(r10)
            boolean r11 = isTransferAtFullNetworkSpeed(r12, r13)     // Catch:{ all -> 0x0072 }
            if (r11 != 0) goto L_0x0009
            monitor-exit(r10)
            return
        L_0x0009:
            int r11 = r10.streamCount     // Catch:{ all -> 0x0072 }
            r12 = 1
        ...
        L_0x0010:
            r11 = 0
        L_0x0011:
            androidx.media3.common.util.Assertions.checkState(r11)     // Catch:{ all -> 0x0072 }
            androidx.media3.common.util.Clock r11 = r10.clock     // Catch:{ all -> 0x0072 }
            long r0 = r11.elapsedRealtime()     // Catch:{ all -> 0x0072 }
            long r2 = r10.sampleStartTimeMs     // Catch:{ all -> 0x0072 }
            long r2 = r0 - r2
            int r5 = (int) r2     // Catch:{ all -> 0x0072 }
            long r2 = r10.totalElapsedTimeMs     // Catch:{ all -> 0x0072 }
            long r6 = (long) r5     // Catch:{ all -> 0x0072 }
            long r2 = r2 + r6
            r10.totalElapsedTimeMs = r2     // Catch:{ all -> 0x0072 }
            long r2 = r10.totalBytesTransferred     // Catch:{ all -> 0x0072 }
            long r6 = r10.sampleBytesTransferred     // Catch:{ all -> 0x0072 }
            long r2 = r2 + r6
            r10.totalBytesTransferred = r2     // Catch:{ all -> 0x0072 }
            if (r5 <= 0) goto L_0x0075
            float r11 = (float) r6     // Catch:{ all -> 0x0072 }
            r13 = 1174011904(0x45fa0000, float:8000.0)
            float r11 = r11 * r13
            float r13 = (float) r5     // Catch:{ all -> 0x0072 }
            float r11 = r11 / r13
            androidx.media3.exoplayer.upstream.SlidingPercentile r13 = r10.slidingPercentile     // Catch:{ all -> 0x0072 }
            double r2 = (double) r6     // Catch:{ all -> 0x0072 }
            double r2 = java.lang.Math.sqrt(r2)     // Catch:{ all -> 0x0072 }
            int r2 = (int) r2     // Catch:{ all -> 0x0072 }
            r13.addSample(r2, r11)     // Catch:{ all -> 0x0072 }
            long r2 = r10.totalElapsedTimeMs     // Catch:{ all -> 0x0072 }
            r6 = 2000(0x7d0, double:9.88E-321)
            int r11 = (r2 > r6 ? 1 : (r2 == r6 ? 0 : -1))
            if (r11 >= 0) goto L_0x0055
            long r2 = r10.totalBytesTransferred     // Catch:{ all -> 0x0051 }
        ...
        L_0x0051:
            ...
            goto L_0x007d
        L_0x0055:
            androidx.media3.exoplayer.upstream.SlidingPercentile r11 = r10.slidingPercentile     // Catch:{ all -> 0x0072 }
            r13 = 1056964608(0x3f000000, float:0.5)
            float r11 = r11.getPercentile(r13)     // Catch:{ all -> 0x0072 }
            long r2 = (long) r11     // Catch:{ all -> 0x0072 }
            r10.bitrateEstimate = r2     // Catch:{ all -> 0x0072 }
        L_0x0060:
            long r6 = r10.sampleBytesTransferred     // Catch:{ all -> 0x0072 }
            long r8 = r10.bitrateEstimate     // Catch:{ all -> 0x0072 }
            r4 = r10
            r4.maybeNotifyBandwidthSample(r5, r6, r8)     // Catch:{ all -> 0x006f }
            r4.sampleStartTimeMs = r0     // Catch:{ all -> 0x006f }
            r10 = 0
            r4.sampleBytesTransferred = r10     // Catch:{ all -> 0x006f }
            goto L_0x0076
        L_0x006f:
            r0 = move-exception
        L_0x0070:
        ...
        L_0x0075:
            r4 = r10
        L_0x0076:
            int r10 = r4.streamCount     // Catch:{ all -> 0x006f }
            int r10 = r10 - r12
            r4.streamCount = r10     // Catch:{ all -> 0x006f }
            monitor-exit(r4)
            return
        L_0x007d:
    ...
    private DefaultBandwidthMeter(Context context2, Map<Integer, Long> map, int i2, Clock clock2, boolean z) {
        Context context3;
        if (context2 == null) {
            context3 = null;
        } else {
        ...
        this.context = context3;
        this.initialBitrateEstimates = Y.a(map);
        this.eventDispatcher = new BandwidthMeter.EventListener.EventDispatcher();
        this.slidingPercentile = new SlidingPercentile(i2);
        this.clock = clock2;
        this.resetOnNetworkTypeChange = z;
        if (context2 != null) {
            NetworkTypeObserver instance = NetworkTypeObserver.getInstance(context2);
            ...
            instance.register(new a(this), BackgroundExecutor.get());
            return;
        }
        this.networkType = 0;
        this.bitrateEstimate = 1000000;
    }
