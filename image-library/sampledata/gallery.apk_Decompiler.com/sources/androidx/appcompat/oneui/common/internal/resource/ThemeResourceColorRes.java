...
public final class ThemeResourceColorRes extends ThemeResourceImpl<Integer> {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ThemeResourceColorRes)) {
            return false;
        }
        ThemeResourceColorRes themeResourceColorRes = (ThemeResourceColorRes) obj;
        if (this.resourceLight == themeResourceColorRes.resourceLight && this.resourceDark == themeResourceColorRes.resourceDark) {
            return true;
        }
        return false;
    }
    ...
    public ThemeResourceColorRes(int i2, int i7) {
