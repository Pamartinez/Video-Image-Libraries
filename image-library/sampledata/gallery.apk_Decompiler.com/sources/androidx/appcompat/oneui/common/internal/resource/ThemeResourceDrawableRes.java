...
public final class ThemeResourceDrawableRes extends ThemeResourceImpl<Integer> {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ThemeResourceDrawableRes)) {
            return false;
        }
        ThemeResourceDrawableRes themeResourceDrawableRes = (ThemeResourceDrawableRes) obj;
        if (this.resourceLight == themeResourceDrawableRes.resourceLight && this.resourceDark == themeResourceDrawableRes.resourceDark) {
            return true;
        }
        return false;
    }
    ...
    public ThemeResourceDrawableRes(int i2, int i7) {
