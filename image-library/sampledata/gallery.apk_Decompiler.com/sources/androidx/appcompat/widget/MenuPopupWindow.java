...
public class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
    ...
    public static class MenuDropDownListView extends DropDownListView {
        ...
        public /* bridge */ /* synthetic */ int measureHeightOfChildrenCompat(int i2, int i7, int i8, int i10, int i11) {
            return super.measureHeightOfChildrenCompat(i2, i7, i8, i10, i11);
        }
        ...
        public boolean onHoverEvent(MotionEvent motionEvent) {
            ...
            if (this.mHoverListener != null) {
                ...
                if (motionEvent.getAction() == 10 || (pointToPosition = pointToPosition((int) motionEvent.getX(), (int) motionEvent.getY())) == -1 || (i7 = pointToPosition - i2) < 0 || i7 >= menuAdapter.getCount()) {
                    menuItemImpl = null;
                } else {
    ...
    public MenuPopupWindow(Context context, AttributeSet attributeSet, int i2, int i7) {
