...
public abstract class ForwardingListener implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    private static boolean pointInView(View view, float f, float f5, float f8) {
        float f10 = -f8;
        if (f < f10 || f5 < f10 || f >= ((float) (view.getRight() - view.getLeft())) + f8 || f5 >= ((float) (view.getBottom() - view.getTop())) + f8) {
            return false;
        }
        return true;
    }
