...
public final class ResourceManagerInternal {
    ...
    private Drawable createDrawableIfNeeded(Context context, int i2) {
        ...
        if (resourceManagerHooks == null) {
            ...
            drawable = resourceManagerHooks.createDrawableFor(this, context, i2);
        }
        if (drawable != null) {
    ...
    public synchronized ColorStateList getTintList(Context context, int i2) {
        ...
        if (tintListFromCache == null) {
            ...
            if (resourceManagerHooks == null) {
                ...
                tintListFromCache = resourceManagerHooks.getTintListForDrawableRes(context, i2);
            }
            if (tintListFromCache != null) {
    ...
    public boolean tintDrawableUsingColorFilter(Context context, int i2, Drawable drawable) {
        ResourceManagerHooks resourceManagerHooks = this.mHooks;
        if (resourceManagerHooks == null || !resourceManagerHooks.tintDrawableUsingColorFilter(context, i2, drawable)) {
            return false;
        }
        return true;
    }
