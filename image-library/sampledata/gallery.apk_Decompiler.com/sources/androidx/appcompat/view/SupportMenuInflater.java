...
public class SupportMenuInflater extends MenuInflater {
    ...
    public static class InflatedOnMenuItemClickListener implements MenuItem.OnMenuItemClickListener {
        ...
        public InflatedOnMenuItemClickListener(Object obj, String str) {
            ...
            try {
                ...
                StringBuilder k = j.k("Couldn't resolve menu item onClick handler ", str, " in class ");
    ...
    public class MenuState {
        ...
        private Menu menu;
        private int navigationMenuItemType = 0;
        ...
        private void setItem(MenuItem menuItem) {
            ...
            MenuItemCompat.setSeslNaviMenuItemType(menuItem, this.navigationMenuItemType);
        }
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            if (obtainStyledAttributes.hasValue(i7)) {
                this.itemIconTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(i7, -1), this.itemIconTintMode);
            } else {
                this.itemIconTintMode = null;
            }
            int i8 = R$styleable.MenuItem_iconTint;
            if (obtainStyledAttributes.hasValue(i8)) {
                this.itemIconTintList = obtainStyledAttributes.getColorStateList(i8);
            } else {
                this.itemIconTintList = null;
            }
            this.navigationMenuItemType = obtainStyledAttributes.getInt(R$styleable.MenuItem_seslNaviMenuItemType, 0);
            obtainStyledAttributes.recycle();
