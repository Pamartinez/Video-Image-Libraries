    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> hashMap) {
        ...
        for (String next : hashMap.keySet()) {
            ...
            try {
                ...
                switch (i2) {
                    case 1:
                        cls.getMethod(l, new Class[]{cls2}).invoke(view, new Object[]{Integer.valueOf(constraintAttribute.mColorValue)});
                        break;
                    case 2:
                        Method method = cls.getMethod(l, new Class[]{Drawable.class});
                        ColorDrawable colorDrawable = new ColorDrawable();
                        colorDrawable.setColor(constraintAttribute.mColorValue);
                        method.invoke(view, new Object[]{colorDrawable});
                        break;
                    case 3:
                        cls.getMethod(l, new Class[]{cls2}).invoke(view, new Object[]{Integer.valueOf(constraintAttribute.mIntegerValue)});
                        break;
                    case 4:
                        cls.getMethod(l, new Class[]{cls3}).invoke(view, new Object[]{Float.valueOf(constraintAttribute.mFloatValue)});
                        break;
                    case 5:
                        cls.getMethod(l, new Class[]{CharSequence.class}).invoke(view, new Object[]{constraintAttribute.mStringValue});
                        break;
                    case 6:
                        cls.getMethod(l, new Class[]{Boolean.TYPE}).invoke(view, new Object[]{Boolean.valueOf(constraintAttribute.mBooleanValue)});
                        break;
                    case 7:
                        cls.getMethod(l, new Class[]{cls3}).invoke(view, new Object[]{Float.valueOf(constraintAttribute.mFloatValue)});
                        break;
                ...
                StringBuilder k = j.k(" Custom Attribute \"", next, "\" not found on ");
                k.append(cls.getName());
                Log.e("TransitionLayout", k.toString());
                e7.printStackTrace();
            } catch (InvocationTargetException e8) {
                StringBuilder k10 = j.k(" Custom Attribute \"", next, "\" not found on ");
