...
public final class HardwareFoldingFeature implements FoldingFeature {
    ...
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0017\u0010\t\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0000¢\u0006\u0004\b\u0007\u0010\b¨\u0006\n"}, d2 = {"Landroidx/window/layout/HardwareFoldingFeature$Companion;", "", "<init>", "()V", "Landroidx/window/core/Bounds;", "bounds", "Lme/x;", "validateFeatureBounds$window_release", "(Landroidx/window/core/Bounds;)V", "validateFeatureBounds", "window_release"}, k = 1, mv = {1, 6, 0}, xi = 48)
    /* compiled from: r8-map-id-85efad48717c48307252110572a40cba967e8b6d39747b0efe99f107082547d8 */
    ...
    public boolean equals(Object obj) {
        ...
        if (!HardwareFoldingFeature.class.equals(cls)) {
            return false;
        }
        if (obj != null) {
            HardwareFoldingFeature hardwareFoldingFeature = (HardwareFoldingFeature) obj;
            if (j.a(this.featureBounds, hardwareFoldingFeature.featureBounds) && j.a(this.type, hardwareFoldingFeature.type) && j.a(getState(), hardwareFoldingFeature.getState())) {
                return true;
            }
            return false;
        }
    ...
    public boolean isSeparating() {
        ...
        if (j.a(type2, companion.getHINGE())) {
            return true;
        }
        if (!j.a(this.type, companion.getFOLD()) || !j.a(getState(), FoldingFeature.State.HALF_OPENED)) {
            return false;
        }
        return true;
    }
