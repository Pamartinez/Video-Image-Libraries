...
public final class SafeWindowLayoutComponentProvider$isWindowLayoutComponentValid$1 extends k implements a {
    ...
    public final Boolean invoke() {
        ...
        j.d(method, "addListenerMethod");
        if (safeWindowLayoutComponentProvider.isPublic(method)) {
            j.d(method2, "removeListenerMethod");
