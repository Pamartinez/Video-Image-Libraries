...
public final class ActivityStack {
    ...
    public boolean equals(Object obj) {
        ...
        if (j.a(this.activities, activityStack.activities) || this.isEmpty == activityStack.isEmpty) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return this.activities.hashCode() + ((this.isEmpty ? 1 : 0) * true);
    }
    ...
    public String toString() {
        ...
        sb2.append(j.j(getActivities$window_release(), "activities="));
