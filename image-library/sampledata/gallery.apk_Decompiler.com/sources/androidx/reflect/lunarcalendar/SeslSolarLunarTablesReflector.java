...
public abstract class SeslSolarLunarTablesReflector {
    ...
    public static byte getLunar(PathClassLoader pathClassLoader, Object obj, int i2) {
        ...
        Object invoke = SeslBaseReflector.invoke(obj, method, Integer.valueOf(i2));
    ...
    public static boolean isLeapMonth(PathClassLoader pathClassLoader, Object obj, int i2, int i7) {
        Class cls = Integer.TYPE;
        ...
        Object invoke = SeslBaseReflector.invoke(obj, method, Integer.valueOf(i2), Integer.valueOf(i7));
