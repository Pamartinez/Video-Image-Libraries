...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
            ...
            if (lifecycleOwner != null && DialogFragment.this.mShowsDialog) {
                ...
                if (requireView.getParent() != null) {
                    ...
                    if (FragmentManager.isLoggingEnabled(3)) {
                        Log.d("SeslDialogFragment", "DialogFragment " + this + " setting the content view on " + DialogFragment.this.mDialog);
                    }
    ...
    private void dismissInternal(boolean z, boolean z3, boolean z7) {
        if (!this.mDismissed) {
    ...
    public LayoutInflater onGetLayoutInflater(Bundle bundle) {
        ...
        if (this.mShowsDialog && !this.mCreatingDialog) {
            ...
            if (!this.mShowsDialog) {
                j.w("mShowsDialog = false: ", str, "SeslDialogFragment");
                return onGetLayoutInflater;
            }
            j.w("mCreatingDialog = true: ", str, "SeslDialogFragment");
        }
        return onGetLayoutInflater;
    }
    ...
    public void setStyle(int i2, int i7) {
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.d("SeslDialogFragment", "Setting style and theme for DialogFragment " + this + " to " + i2 + ArcCommonLog.TAG_COMMA + i7);
        }
        this.mStyle = i2;
        if (i2 == 2 || i2 == 3) {
