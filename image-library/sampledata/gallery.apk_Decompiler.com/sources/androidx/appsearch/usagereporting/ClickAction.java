...
public class ClickAction extends TakenAction {
    ...
    public static final class Builder extends TakenAction.BuilderImpl<Builder> {
        ...
        private long mTimeStayOnResultMillis = -1;
        ...
        public Builder setTimeStayOnResultMillis(long j2) {
            this.mTimeStayOnResultMillis = j2;
            return this;
        }
    }

    public ClickAction(String str, String str2, long j2, long j3, int i2, String str3, String str4, int i7, int i8, long j8) {
        super(str, str2, j2, j3, i2);
        this.mQuery = str3;
        this.mReferencedQualifiedId = str4;
        this.mResultRankInBlock = i7;
        this.mResultRankGlobal = i8;
        this.mTimeStayOnResultMillis = j8;
    }
}
