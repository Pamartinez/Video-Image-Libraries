...
public abstract class ColorStateListInflaterCompat {
    ...
    private static int modulateColorAlpha(int i2, float f, float f5) {
        boolean z;
        ...
        int clamp = MathUtils.clamp((int) ((((float) Color.alpha(i2)) * f) + 0.5f), 0, (int) ScoverState.TYPE_NFC_SMART_COVER);
        if (z) {
            CamColor fromColor = CamColor.fromColor(i2);
            i2 = CamColor.toColor(fromColor.getHue(), fromColor.getChroma(), f5);
        }
