...
public class NestedScrollingChildHelper {
    ...
    public boolean dispatchNestedFling(float f, float f5, boolean z) {
        ...
        return ViewParentCompat.onNestedFling(nestedScrollingParentForType, this.mView, f, f5, z);
    }
    ...
    public boolean dispatchNestedPreFling(float f, float f5) {
        ...
        return ViewParentCompat.onNestedPreFling(nestedScrollingParentForType, this.mView, f, f5);
    }
    ...
    public boolean dispatchNestedScroll(int i2, int i7, int i8, int i10, int[] iArr) {
        return dispatchNestedScrollInternal(i2, i7, i8, i10, iArr, 0, (int[]) null);
    }

    public ViewParent getNestedScrollingParent(int i2) {
        return getNestedScrollingParentForType(i2);
    }
    ...
    public boolean seslDispatchNestedScroll(int i2, int i7, int i8, int i10, int[] iArr, int i11, int[] iArr2) {
        return dispatchNestedScrollInternal(i2, i7, i8, i10, iArr, i11, iArr2);
    }
    ...
    public boolean dispatchNestedPreScroll(int i2, int i7, int[] iArr, int[] iArr2, int i8) {
        ...
        iArr3[0] = 0;
        iArr3[1] = 0;
        ViewParentCompat.onNestedPreScroll(nestedScrollingParentForType, this.mView, i2, i7, iArr3, i8);
        if (iArr2 != null) {
            this.mView.getLocationInWindow(iArr2);
            iArr2[0] = iArr2[0] - i11;
            iArr2[1] = iArr2[1] - i10;
    ...
    public boolean dispatchNestedScroll(int i2, int i7, int i8, int i10, int[] iArr, int i11) {
        return dispatchNestedScrollInternal(i2, i7, i8, i10, iArr, i11, (int[]) null);
    }
    ...
    public boolean startNestedScroll(int i2, int i7) {
        ...
        for (ViewParent parent = this.mView.getParent(); parent != null; parent = parent.getParent()) {
            if (ViewParentCompat.onStartNestedScroll(parent, view, this.mView, i2, i7)) {
                setNestedScrollingParentForType(i7, parent);
                ViewParentCompat.onNestedScrollAccepted(parent, view, this.mView, i2, i7);
                return true;
            }
    ...
    public void stopNestedScroll(int i2) {
        ...
        if (nestedScrollingParentForType != null) {
            ...
            setNestedScrollingParentForType(i2, (ViewParent) null);
        }
    }

    public void dispatchNestedScroll(int i2, int i7, int i8, int i10, int[] iArr, int i11, int[] iArr2) {
        dispatchNestedScrollInternal(i2, i7, i8, i10, iArr, i11, iArr2);
    }
}
