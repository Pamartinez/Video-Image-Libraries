...
final class ToContinuation<T> implements Runnable {
    ...
    public ToContinuation(ListenableFuture listenableFuture, C0873j jVar) {
        j.e(listenableFuture, "futureToObserve");
        j.e(jVar, "continuation");
    ...
    public void run() {
        ...
        try {
            ...
            this.continuation.resumeWith(a.l(WorkerWrapperKt.nonNullCause(e)));
        }
    }
}
