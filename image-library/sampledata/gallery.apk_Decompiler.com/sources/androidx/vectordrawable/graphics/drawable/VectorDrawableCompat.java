...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static class VectorDrawableCompatState extends Drawable.ConstantState {
        ...
        public boolean canReuseBitmap(int i2, int i7) {
            if (i2 == this.mCachedBitmap.getWidth() && i7 == this.mCachedBitmap.getHeight()) {
                return true;
            }
            return false;
        }
        ...
        public void createCachedBitmapIfNeeded(int i2, int i7) {
            if (this.mCachedBitmap == null || !canReuseBitmap(i2, i7)) {
                this.mCachedBitmap = Bitmap.createBitmap(i2, i7, Bitmap.Config.ARGB_8888);
        ...
        public void updateCachedBitmap(int i2, int i7) {
            this.mCachedBitmap.eraseColor(0);
            this.mVPathRenderer.draw(new Canvas(this.mCachedBitmap), i2, i7, (ColorFilter) null);
        }
    ...
    public static int applyAlpha(int i2, float f) {
        return (i2 & 16777215) | (((int) (((float) Color.alpha(i2)) * f)) << 24);
    }
    ...
    private void inflateInternal(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        while (eventType != 1 && (xmlPullParser.getDepth() >= depth || eventType != 3)) {
            if (eventType == 2) {
                ...
                if (FileApiContract.Parameter.PATH.equals(name)) {
    ...
    public static class VPathRenderer {
        ...
        public VPathRenderer() {
            ...
            this.mRootAlpha = ScoverState.TYPE_NFC_SMART_COVER;
            this.mRootName = null;
        ...
        private static float cross(float f, float f5, float f8, float f10) {
            return (f * f10) - (f5 * f8);
        }

        private void drawGroupTree(VGroup vGroup, Matrix matrix, Canvas canvas, int i2, int i7, ColorFilter colorFilter) {
            VGroup vGroup2 = vGroup;
            vGroup2.mStackedMatrix.set(matrix);
            vGroup2.mStackedMatrix.preConcat(vGroup2.mLocalMatrix);
            canvas.save();
            int i8 = 0;
            while (i8 < vGroup2.mChildren.size()) {
                VObject vObject = vGroup2.mChildren.get(i8);
                if (vObject instanceof VGroup) {
                    drawGroupTree((VGroup) vObject, vGroup2.mStackedMatrix, canvas, i2, i7, colorFilter);
                } else if (vObject instanceof VPath) {
                    drawPath(vGroup2, (VPath) vObject, canvas, i2, i7, colorFilter);
                }
                i8++;
                vGroup2 = vGroup;
            }
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int i2, int i7, ColorFilter colorFilter) {
            Path.FillType fillType;
            Path.FillType fillType2;
            float f = ((float) i2) / this.mViewportWidth;
            float f5 = ((float) i7) / this.mViewportHeight;
        ...
        public void draw(Canvas canvas, int i2, int i7, ColorFilter colorFilter) {
            drawGroupTree(this.mRootGroup, IDENTITY_MATRIX, canvas, i2, i7, colorFilter);
        }
