...
@Metadata(d1 = {"\u0000\u0016\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007¢\u0006\u0004\b\u0003\u0010\u0004J\u0010\u0010\u0005\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0007H\u0016J\u0010\u0010\b\u001a\u00020\u00072\u0006\u0010\t\u001a\u00020\u0002H\u0016¨\u0006\n"}, d2 = {"androidx/appfunctions/internal/serializableproxies/$InstantFactory", "Landroidx/appfunctions/internal/AppFunctionSerializableFactory;", "Ljava/time/Instant;", "<init>", "()V", "fromAppFunctionData", "appFunctionData", "Landroidx/appfunctions/AppFunctionData;", "toAppFunctionData", "appFunctionSerializable", "appfunctions"}, k = 1, mv = {2, 0, 0}, xi = 48)
/* renamed from: androidx.appfunctions.internal.serializableproxies.$InstantFactory  reason: invalid class name */
...
public final class C$InstantFactory implements AppFunctionSerializableFactory<Instant> {
    ...
    public Instant fromAppFunctionData(AppFunctionData appFunctionData) {
        ...
        AppFunctionData appFunctionDataWithSpec = super.getAppFunctionDataWithSpec(appFunctionData, "java.time.Instant");
        ...
        if (longOrNull != null) {
            ...
            if (intOrNull != null) {
                return new AppFunctionInstant(longValue, intOrNull.intValue()).toInstant();
            }
    ...
    public AppFunctionData toAppFunctionData(Instant instant) {
        j.e(instant, "appFunctionSerializable");
        AppFunctionInstant fromInstant = AppFunctionInstant.Companion.fromInstant(instant);
        AppFunctionData.Builder appFunctionDataBuilder = super.getAppFunctionDataBuilder("java.time.Instant");
        appFunctionDataBuilder.setLong("epochSecond", fromInstant.getEpochSecond());
        appFunctionDataBuilder.setInt("nanoAdjustment", fromInstant.getNanoAdjustment());
